                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="dropify" name="photo" data-bs-height="180" data-default-file="{{ asset($banner->photo) }}"/>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="banner_description" placeholder="Description" value="{{ $banner->banner_description }}">
                                </div>
                            </div>
